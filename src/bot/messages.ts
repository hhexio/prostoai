...
🎁 Вам начислено <b>15 000</b> токенов для знакомства.

💬 Просто напишите вопрос — и я отвечу!
🎨 Или отправьте фото, голосовое сообщение.

Дополнительные модели и настройки — в меню ниже.`,
